...
function GameField({field, openCells, countStart, changeFace, changeFaceNormal, plantFlag, removeFlag, startGame, gameOver, restart, putFlag, loss}) {
